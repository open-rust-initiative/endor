...
The `Endor` project relies on community contributions and aims to simplify getting started. To develop `Endor`, clone the repository, then install all dependencies, run the test suite and try it out locally. Pick an issue, make changes, and submit a pull request for community review.
...
If you have any questions or suggestions about `Endor`, please feel free to contact us.
